Shader "Unreal/M_SW_NRMAC_Master_ATLAS"
{
    Properties
    {
		...
		_NormalMap( "NRMMap", 2D ) = "white" {}
		 [HDR] _EmissiveColor("EmissiveColor", Color) = (0, 0, 0)
        _EmissiveColorMap( "EmissiveMap", 2D ) = "black" {}
        _EmissiveIntensity("Emissive Intensity", Float) = 1
        _EmissiveScale("Emissive Scale", Float) = 1
		SelectionColor( "SelectionColor", Color ) = (0.000000, 0.000000, 0.000000, 0.000000 )
		AtlasSize( "AtlasSize", Float ) = 4096.000000
		AtlasTileSize( "AtlasTileSize", Float ) = 256.000000
		Padding( "Padding", Float ) = 2.000000
		SpecPosCount( "SpecPosCount", Float ) = 0.000000
