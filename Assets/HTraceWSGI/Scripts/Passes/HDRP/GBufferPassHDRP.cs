	...
	internal class GBufferPassHDRP : ScriptableRenderPass
	{
		...
		private static void GBufferGeneration(CommandBuffer cmd, RenderingData renderingData)
		{
			using (new HTraceProfilingScope(cmd, GBufferProfilingSampler))
			{
                ...
                // URP��û��litShaderMode��Forwardģʽ��GBuffer0Ϊnullʱ��Dummy���
                if (NativeGBuffer0 == null)
					NativeGBuffer0 = Dummy.rt;

				var cameraData = renderingData.cameraData;

                // URP��ͨ��RTHandle��ȡ����ĸ���Buffer
                // _CameraDepthTexture      -> ���
                // _CameraNormalsTexture    -> ����
                // _CameraOpaqueTexture     -> ��ɫ
                ...
                var EmissionGBuffer = Shader.GetGlobalTexture(HShaderParams._GBuffer3);
				...
				cmd.SetGlobalTexture(HShaderParams._GBufferTexture3,           EmissionGBuffer);
