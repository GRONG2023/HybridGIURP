...
namespace HTraceWSGI.Scripts.Editor
{
	internal static class HEditorStyles
	{
		...
		public static readonly GUIContent ClipmapRangeContent = new GUIContent("ClipmapRange", "Controls the maximum size (in meters) that the voxelization bound can cover.");
